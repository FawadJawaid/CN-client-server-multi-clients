...
public class ServerGUI extends javax.swing.JFrame {
    ...
    private void sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendActionPerformed
        ...
        if (msg.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "No Client Connected !!!", "Connection Error", JOptionPane.ERROR_MESSAGE);
        } else {
            mcs.write(msg.getText());
            ...
            public void run() {
                ...
                Thread listen = new Thread(new Runnable() {
                    ...
                    public void run() {
                        while (true) {
                            try {
                                mcs = new MultiClientServer(ssoc.accept());
                                new Thread(mcs).start();
                            } catch (IOException ex) {
                                Logger.getLogger(ServerGUI.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
    ...
    public static javax.swing.JTextArea msgview;
